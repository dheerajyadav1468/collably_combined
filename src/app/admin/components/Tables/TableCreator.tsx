...
const CreatorData: CREATOR[] = [
  ...
  {
    logo: "/images/creator/sidharth.jpeg",
...
const TableCreator = () => {
  ...
  const handleViewClick = (creatorName: string, creatorLogo: string, creatorVisitors: number, creatorRevenues: string, creatorSales: number) => {
    router.push(`/profile?creator=${encodeURIComponent(creatorName)}&logo=${encodeURIComponent(creatorLogo)}&visitors=${encodeURIComponent(creatorVisitors)}&revenues=${encodeURIComponent(creatorRevenues)}&sales=${encodeURIComponent(creatorSales)}`);
};
          ...
          >
            <div className="flex items-center gap-3.5 px-2 py-4">
              <div className="flex-shrink-0">
                <Image src={creator.logo} alt="creator" width={48} height={48}  style={{ borderRadius: '50%' }} />
              </div>
            ...
            <div className="hidden items-center justify-center px-2 py-4 md:flex">
              <div className="flex items-center space-x-3.5">
                <button
                  ...
                  onClick={() => handleViewClick(creator.name, creator.logo, creator.visitors, creator.revenues, creator.sales)}
                >
                  <svg
